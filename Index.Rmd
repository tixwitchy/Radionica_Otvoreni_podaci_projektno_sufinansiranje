...
- Obuhvatio je **`r n_distinct(tabela[,1])`** davaoca sredstava: Pokrajinski sekretarijat, Ministarstvo kulture i informisanja i **`r n_distinct(tabela[,1])-2`** lokalne samouprave i **`r format(n_distinct(tabela[,4])-1,big.mark = ",")`** podnosioca projekata;
